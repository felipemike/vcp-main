...
class vCP extends sql {
	...
	// Seta uma mensagem para aparecer dentro da div de informa��es
	...
	// Retorna true se estiver logado e false caso contr�rio
	public function isLogged() {
		return (isset($_SESSION['v_logged'])) ? true : false;
	}

	// Redireciona para p�gina de login caso n�o esteja logado
	...
	// Busca todos os tops cadastrados, se passado true como primeiro par�metro ele retorna em formato de select: <option...
	...
	// Pega as informa��es do top
	public function getTopInfos($id) {
		return $this->query(GET_TOP, array($id));
	}
	
	// Checa se a pessoa pode votar nesse top atrav�s da tabela
	...
	// Checa se a pessoa pode votar nesse top atrav�s do cookie
	...
	// Checa o level e redireciona caso n�o tenha suficiente para acessar a p�gina
	...
	// Envia para o endere�o informado
